...
React JS is a JavaScript library. It makes it so you aren't inputing each piece of data everytime an update is needed.

1. Describe component state.

Component State is when state changes or updates the component/ re-renders.
...
A side effect is when something is changed or affected outside the scope of the function. An example is an API, you use effects by ussing useEffect or useState.
